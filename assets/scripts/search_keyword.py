...
def main(device_id):
    ...
    print(f"[{device_id}] Starting Instagram 'Search & Reel' script for keyword: '{SEARCH_KEYWORD}'")
    ...
    try:
        ...
        d(resourceId="com.instagram.android:id/action_bar_search_edit_text").set_text(SEARCH_KEYWORD)
        d.press("enter")
        time.sleep(4)

        print(f"[{device_id}] Switching to Reels tab for the keyword...")
        reels_search_tab = d(text="Reels")
        ...
        d(resourceId="com.instagram.android:id/image_preview")[0].click()
        time.sleep(3)
